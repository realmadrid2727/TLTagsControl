...
@property (nonatomic, strong) IBOutlet TLTagsControl *defaultListingTagControl;
...
- (void)viewDidLoad {
  ...
  NSMutableArray *tags = [NSMutableArray arrayWithArray:@[@"A", @"Tag", @"One", @"More"]];
