...
@interface TLTagsControl () <UITextFieldDelegate, UIGestureRecognizerDelegate, ODTextFieldDelegate>

@end

@implementation TLTagsControl {
  ODTextField                 *tagInputField_;
...
- (void)commonInit {
  ...
  tagInputField_ = [[ODTextField alloc] initWithFrame:self.frame];
  ...
  tagInputField_.keyTapDelegate = self;
  tagInputField_.font = [UIFont systemFontOfSize:14.0];
